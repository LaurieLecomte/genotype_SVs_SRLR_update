...
vg pack --xg $GRAPH_DIR/graph_regions_giraffe.xg --gam $ALIGNED_DIR/"$SAMPLE"_regions_giraffe.gam --packs-out $APACKS_DIR/"$SAMPLE"_regions_giraffe.pack --min-mapq 5 --threads $CPU
